...
def main_rename(dir,label):
    ...
    output_path = '../data/%s_sample_label.csv' % dir
...
def main_split_data(data_path):
    ...
    train_data,val_data,train_label,val_label = split_data(train_val_x,train_val_y,split_ratio=0.1)

    "train, test, val output path"
    train_data_path = '../data/train_data_label.csv'
    test_data_path = '../data/test_data_label.csv'
    val_data_path = '../data/val_data_label.csv'
...
if __name__ == '__main__':
    ...
    # dir = 'mal'
    # label = 1
    # main_rename(dir,label)

    " concatenate benign and mal in csv as final dataset"
    # benign = pd.read_csv('../data/benign_sample_label.csv')
    # mal = pd.read_csv('../data/mal_sample_label.csv')
    # out_path = '../data/pe_data_label.csv'
    ...
    # all_pe_data = '../data/pe_data_label.csv'
