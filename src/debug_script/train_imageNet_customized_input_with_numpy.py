...
Details:
instead of using transform function, which the resize function use interplation default.
different to resize function in numpy. in this script, we use resize function from numpy

customized input: lodd image --> convert to bytes --> flatten --> cut/pad to fixed size
--> reshape to [1,resolution,resolution] image
"""
import os
os.sys.path.append('..')
