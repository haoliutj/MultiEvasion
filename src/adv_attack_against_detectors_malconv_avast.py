"""
against two models: MalConv and AvastNet
...
def main_test():
    ...
    model_2 = AvastNet_freezeEmbed(vocab_size=256).to(device)
...
if __name__ == '__main__':
    ...
    if args.adversary == 'FGSM':
        file_name = ('_' + args.adversary +'_eps'+str(args.eps) + '_extend'+str(args.preferable_extension_amount)
                     +'_shift'+str(args.preferable_shift_amount) + '_'
                     + evasion_attack_name+ '_w1_'+str(args.w_1)+ '_w2_'+str(args.w_2) + '.').join(file_name_split[-1].split('.'))
    elif args.adversary == 'FFGSM':
        ...
        file_name = ('_' + args.adversary +'_eps'+str(args.eps)+'_alpha'+str(args.alpha)+'_iter'
                     ...
                     +str(args.preferable_shift_amount) + '_'
                     + evasion_attack_name+ '_w1_'+str(args.w_1)+ '_w2_'+str(args.w_2) + '.').join(file_name_split[-1].split('.'))
